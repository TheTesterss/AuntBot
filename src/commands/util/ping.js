...
module.exports = {
    ...
    permissions: ["Administrator", "ManageEmojisAndStickers", "ManageRoles"],
    botPermissions: ["Administrator", "ManageEmojisAndStickers", "ManageRoles"],
    voiceOnly: false,
    ownerOnly: false,
    adminOnly: false,
    //blacklistAllowed: false, NOT AVAILABLE RIGHT NOW NEXT UPDATE
     ...
     * @param {null} _db 
     */
    execute: async (bot, interaction, _db) => {
